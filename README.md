...
Accuracy на тестовой выборке: `0.7941176470588235`
...
* `--rm-frames` - флаг: удалить папку с нарезанными кадрами по завершению или оставить;
...
Для инференса модель можно скачать с Google.Drive: https://drive.google.com/file/d/1Zpsce7_G_PhH8wD8-F2aZiGhhqG3lLRJ/view?usp=sharing
